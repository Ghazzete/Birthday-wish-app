...
export default function BirthdayWish() {
  ...
  const [balloonsPoppedCount, setBalloonPoppedCount] = useState<number>(0);
  ...
  }; // <- Closing brace for the celebrate function

  return (
    // Main container
    <div className="min-h-screen bg-fuchsia-100 flex items-center justify-center p-4">
      ...
      >
        {/* Birthday card */}
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black rounded-2xl">
          {/* Card header with birthday message */}
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-sky-700">
              Happy 19th Birthday!
            </CardTitle>
            <CardDescription className="text-2xl font-semibold text-sky-700">
              Fizza Muhammad Rasheed
            </CardDescription>
            <p className="text-lg text-sky-700">January 21st</p>
          </CardHeader>
